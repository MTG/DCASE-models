...
dataset_class = get_available_datasets()[args.destination_dataset]
...
exp_folder_source = os.path.join(folder_models, args.model, args.source_dataset)
exp_folder_source_fold = os.path.join(exp_folder_source, fold_test)

exp_folder_destination = os.path.join(folder_models, args.model, args.source_dataset + '_ft_' + args.destination_dataset)
...
model_container = model_container_class(model=None, model_path=exp_folder_source_fold)
